...
public class PieceTextMapper {

    private final Map<Piece, String> pieceTextMap;

    public PieceTextMapper(Map<Piece, String> pieceTextMap) {
        this.pieceTextMap = pieceTextMap;
    }

    public static PieceTextMapper initialize() {
        ...
        return new PieceTextMapper(pieceTextMap);
    }
